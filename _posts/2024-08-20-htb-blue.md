...
To exploit this vulnerability I use a bash script I made that will automate all the process [bluepwn-ms17-010](https://github.com/s3ntrysec/bluepwn-ms17-010)

```bash
$ git clone https://github.com/s3ntrysec/bluepwn-ms17-010
$ cd bluepwn-ms17-010
$ ./bluepwn.sh
```
